...
public class NetworkReceiver extends BroadcastReceiver {
     ...
     */
    public boolean checkSilentConnection() {
    ...
    public void onReceive(Context context, Intent intent) {
        boolean status = checkSilentConnection();

        // If the class implements UpdatableWeather, calls to
        // the method updateWeather when is changed.
        if (context instanceof UpdatableWeather) {
            ((UpdatableWeather) context).onUpdateWeather(status);
        }
